...
Dalam kode di atas, dataset CIFAR-10 dibaca dari file-file batch yang terletak dalam direktori data_dir. Fungsi unpickle membantu membuka file tersebut, dan kemudian dilakukan iterasi melalui setiap batch. Setiap gambar dalam batch dipecah menjadi tiga bagian yang mewakili channel RGB, kemudian dikombinasikan kembali untuk membentuk array gambar 32x32x3 menggunakan np.dstack. Labels dari setiap gambar juga disimpan.
